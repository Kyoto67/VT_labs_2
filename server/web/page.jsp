...
<div class="Input_Block">
    ...
    <div class="data">
        ...
        <p>
            <button class="Rbutton" name="R" value="1" type="button" onclick="R_1()">1</button>
            <button class="Rbutton" name="R" value="2" type="button" onclick="R_2()">2</button>
            <button class="Rbutton" name="R" value="3" type="button" onclick="R_3()">3</button>
            <button class="Rbutton" name="R" value="4" type="button" onclick="R_4()">4</button>
            <button class="Rbutton" name="R" value="5" type="button" onclick="R_5()">5</button>
        </p>
